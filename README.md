...
runcmd:
  - curl https://raw.githubusercontent.com/JQ-Networks/nixos-infect/master/nixos-infect | PROVIDER=digitalocean NIX_CHANNEL=nixos-20.09 bash 2>&1 | tee /tmp/infect.log
```
Potential tweaks:
...
runcmd:
  - curl https://raw.githubusercontent.com/JQ-Networks/nixos-infect/master/nixos-infect | PROVIDER=digitalocean NIXOS_IMPORT=./host.nix NIX_CHANNEL=nixos-20.09 bash 2>&1 | tee /tmp/infect.log
...
curl https://raw.githubusercontent.com/JQ-Networks/nixos-infect/master/nixos-infect | NIX_CHANNEL=nixos-20.09 bash
```
...
curl https://raw.githubusercontent.com/JQ-Networks/nixos-infect/master/nixos-infect | NIX_CHANNEL=nixos-20.09 bash 2>&1 | tee /tmp/infect.log
```
